...
interface ANetService {
    ...
    suspend fun getImagesOfAd(@Path("ad_id") adId: Long): List<Long>
    ...
    @GET("api/ad/remove")
    suspend fun deleteAd(@Query("ad_id") adId: Long): Response<ResponseBody>

    @GET("api/bookmark")
    suspend fun getMyBookmarks(): List<Ad>

    @GET("api/bookmark/create")
    suspend fun addBookmark(@Query("ad_id") adId: Long): Response<ResponseBody>

    @GET("api/bookmark/remove")
    suspend fun deleteBookmark(@Query("ad_id") adId: Long): Response<ResponseBody>

    @GET("api/has_bookmark")
    suspend fun hasBookmark(@Query("ad_id") adId: Long): HasBookmark
